...
const TEACHER_DISCOUNTS = [
  { name: "Barnes & Noble Educator Program",       savings: "20% off",        grade: "All Ages" as GradeTag, url: "https://stores.barnesandnoble.com/content/educator-appreciation", desc: "Educators and homeschool parents get 20% off in-store and online purchases. Bring proof of homeschool enrollment.", tags: ["Books", "Supplies"] },
  { name: "Office Depot / OfficeMax Teacher Rewards", savings: "Up to 10%",   grade: "All Ages" as GradeTag, url: "https://www.officedepot.com/l/teacher-rewards", desc: "Free membership gives 5–10% back in rewards on eligible purchases. Valid for homeschool families.", tags: ["Supplies", "Tech"] },
  { name: "JoAnn Fabrics Teacher Discount",        savings: "15% off",        grade: "All Ages" as GradeTag, url: "https://www.joann.com/teacher-discount", desc: "15% teacher discount every day for educators and homeschool parents. Show a homeschool ID or letter at checkout.", tags: ["Art", "Crafts"] },
  { name: "Apple Teacher",                         savings: "Free resources", grade: "All Ages" as GradeTag, url: "https://www.apple.com/education/k12/teacher-resources", desc: "Free Apple Teacher certification and educational resources, lesson ideas, and professional learning for educators.", tags: ["Tech", "Digital"] },
  { name: "Staples Teacher Rewards",               savings: "5% back",        grade: "All Ages" as GradeTag, url: "https://www.staples.com/sbd/cre/programs/teacherRewards", desc: "Free program offering 5% back in rewards plus back-to-school savings events throughout the year.", tags: ["Supplies", "Tech"] },
  { name: "Discount School Supply",                savings: "Ongoing sales",  grade: "All Ages" as GradeTag, url: "https://www.discountschoolsupply.com", desc: "Dedicated to homeschool and classroom supplies. Check their educator section for deep discounts on bulk supplies.", tags: ["Supplies", "Art"] },
  { name: "Khan Academy",                          savings: "100% free",      grade: "All Ages" as GradeTag, url: "https://www.khanacademy.org", desc: "Completely free, world-class education for anyone. Math, science, history, and more — including SAT prep.", tags: ["Digital", "All subjects"] },
  { name: "Amazon Homeschool Discounts",           savings: "Varies",         grade: "All Ages" as GradeTag, url: "https://www.amazon.com/b?node=16225007011", desc: "Search for educator and homeschool bundles. Amazon Smile also donates 0.5% of purchases to a homeschool organization of your choice.", tags: ["Books", "Supplies"] },
];
