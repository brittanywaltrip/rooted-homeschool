...
const FRESH_DROPS_POOL: FreshDrop[] = [
  ...
  { emoji: "🧪", name: "Crystal Growing",               type: "Science",     grade: "3–5",      url: "https://www.sciencebuddies.org/stem-activities/how-to-grow-crystals", desc: "Grow stunning crystals at home — a perfect multi-day science project." },
  ...
  { emoji: "🦒", name: "San Diego Zoo Virtual Safari",  type: "Field Trip",  grade: "K–2",      url: "https://zoo.sandiegozoo.org/school-youth-programs/recorded-field-trip",                         desc: "Live cams and virtual field trips featuring giraffes, pandas, and more." },
  ...
  { emoji: "⚡", name: "Homemade Electromagnet",        type: "Science",     grade: "6–8",      url: "https://www.sciencebuddies.org/stem-activities/build-a-simple-circuit", desc: "A nail + copper wire + 9V battery = a working magnet. Teaches electromagnetism." },
...
const EASY_WINS: EasyWin[] = [
  ...
  { emoji: "🍳", title: "Kitchen Math",               desc: "Double a recipe together. Real fractions, real reward, and everyone eats the results.",   time: "20 min",   grade: "3–8",      url: "https://www.khanacademy.org/math/arithmetic/fraction-arithmetic" },
...
const VIRTUAL_TOURS: VirtualTour[] = [
  { emoji: "🏯", name: "Walk the Great Wall of China",     url: "https://www.youtube.com/watch?v=AtMiGFxkIaE",           desc: "Narrated walking tour of one of the world's greatest wonders.",                                                                                grade: "All Ages", subject: "History/Geography" },
  { emoji: "🔺", name: "Inside the Egyptian Pyramids",     url: "https://www.youtube.com/watch?v=Mxzjbq6BQOQ",           desc: "360° virtual tour inside the Pyramids of Giza.",                                                                                       grade: "All Ages", subject: "History/Science"   },
  { emoji: "🌿", name: "Amazon Rainforest Virtual Tour",   url: "https://www.youtube.com/watch?v=o1ReMbG9mzs",           desc: "Aerial and ground-level exploration of the rainforest.",                                                                                grade: "All Ages", subject: "Science/Nature"    },
  { emoji: "🐙", name: "Monterey Bay Aquarium Live",       url: "https://www.youtube.com/watch?v=3oHXXgxvs4k",           desc: "Live underwater cameras from the famous aquarium.",                                                                                    grade: "All Ages", subject: "Science"           },
  { emoji: "🖼️", name: "The Louvre Museum Tour",           url: "https://www.youtube.com/watch?v=RVkEBjSqFEo",           desc: "Walk the halls of the world's most visited museum.",                                                                                   grade: "All Ages", subject: "Art/History"       },
  ...
  { emoji: "🌋", name: "Yellowstone National Park",        url: "https://www.youtube.com/watch?v=CqZJaFJVkBo",           desc: "Geysers, wildlife, and volcanic landscapes in stunning detail.",                                                                        grade: "All Ages", subject: "Science/Nature"    },
  { emoji: "🚀", name: "International Space Station Tour", url: "https://www.youtube.com/watch?v=DhmdyQdu96M",           desc: "NASA astronaut guides you through the ISS.",                                                                                           grade: "All Ages", subject: "Science/Space"     },
  { emoji: "🥒", name: "Mount Olive Pickle Factory Tour",  url: "https://www.youtube.com/watch?v=71_GQLSpYXs",           desc: "See how pickles are made inside the Mount Olive Pickle Company — a real-world look at food manufacturing.",                            grade: "All Ages", subject: "Career/Food Science" },
];
