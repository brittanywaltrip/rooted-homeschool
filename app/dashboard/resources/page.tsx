...
const VIRTUAL_TOURS: VirtualTour[] = [
  { emoji: "🏯", name: "Walk the Great Wall of China",     url: "https://www.youtube.com/watch?v=R6MpC0hpBW4",           desc: "Narrated walking tour of one of the world's greatest wonders.",                                                                                grade: "All Ages", subject: "History/Geography" },
  { emoji: "🔺", name: "Inside the Egyptian Pyramids",     url: "https://www.youtube.com/watch?v=qKkPHaJKNzs",           desc: "360° virtual tour inside the Pyramids of Giza.",                                                                                       grade: "All Ages", subject: "History/Science"   },
  { emoji: "🌿", name: "Amazon Rainforest Virtual Tour",   url: "https://www.youtube.com/watch?v=mGMBoAhkSnQ",           desc: "Aerial and ground-level exploration of the rainforest.",                                                                                grade: "All Ages", subject: "Science/Nature"    },
  { emoji: "🐙", name: "Monterey Bay Aquarium Live",       url: "https://www.youtube.com/watch?v=B3EGCu59fZ8",           desc: "Live underwater cameras from the famous aquarium.",                                                                                    grade: "All Ages", subject: "Science"           },
  { emoji: "🖼️", name: "The Louvre Museum Tour",           url: "https://www.youtube.com/watch?v=nVQcGGxB4tg",           desc: "Walk the halls of the world's most visited museum.",                                                                                   grade: "All Ages", subject: "Art/History"       },
  ...
  { emoji: "🌋", name: "Yellowstone National Park",        url: "https://www.youtube.com/watch?v=2MIMJLjcAv8",           desc: "Geysers, wildlife, and volcanic landscapes in stunning detail.",                                                                        grade: "All Ages", subject: "Science/Nature"    },
  { emoji: "🚀", name: "International Space Station Tour", url: "https://www.youtube.com/watch?v=Pjk_4iAeHGY",           desc: "NASA astronaut guides you through the ISS.",                                                                                           grade: "All Ages", subject: "Science/Space"     },
