...
const FRESH_DROPS_POOL: FreshDrop[] = [
  ...
  { emoji: "🌋", name: "Baking Soda Volcano",           type: "Science",     grade: "K–2",      url: "https://www.sciencebuddies.org/science-fair-projects/search?q=baking+soda+volcano", desc: "The classic acid-base eruption — add dish soap for dramatic foam." },
