        ...
        <div className="prose prose-sm max-w-none space-y-8 text-[#5c5248]">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 mt-3 space-y-2 leading-relaxed">
              ...
              <li>Photos uploaded by parents may contain children. These photos are uploaded entirely at the parent&apos;s discretion, stored privately within the parent&apos;s account, never used for advertising, never used to train AI or machine learning models, and never shared with any third party. Parents may delete any photo at any time from within the app.</li>
