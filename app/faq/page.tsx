...
const sections = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. Go to More, then Years, and tap Add a past year. Give the year its dates and school days, and enter each child's curricula with how many lessons they finished. The year is filed as closed, so it shows in Years, on Reports for those dates, and on the year-end summary, and your current year is not changed. You also say about how many days you schooled, which is the attendance Reports shows for that year, and you can change it later from Years.",
      },
      {
