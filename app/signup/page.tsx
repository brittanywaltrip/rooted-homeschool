  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="flex-1 flex flex-col">
        {/* Mobile brand header */}
        <div className="lg:hidden w-full bg-[var(--g-brand)] px-6 py-8 text-center">
        ...
        <div className="flex-1 bg-[#f8f7f4] flex flex-col items-center justify-center px-6 py-12">
          <div className="w-full max-w-sm bg-[#fefcf9] border border-[#e8e2d9] rounded-2xl shadow-sm p-8">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 bg-black hover:bg-[#1a1a1a] text-white font-medium py-3 rounded-xl transition-colors mt-3"
            >
