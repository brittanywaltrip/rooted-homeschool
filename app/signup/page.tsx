          ...
          <div className="w-full max-w-sm bg-[#fefcf9] border border-[#e8e2d9] rounded-2xl shadow-sm p-8">
            ...
            <form onSubmit={handleSignup} className="flex flex-col gap-4">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Jane"
                    className="w-full px-4 py-2.5 rounded-xl border border-[#e8e2d9] bg-white text-[#2d2926] placeholder-[#b5aca4] focus:outline-none focus:border-[#3d5c42] focus:ring-2 focus:ring-[#3d5c42]/20 transition"
                  />
                </div>
                <div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-[#3d5c42] hover:bg-[#2d4a32] disabled:opacity-60 text-white font-medium py-3 rounded-xl transition-colors mt-1"
              >
            ...
            <p className="text-center text-sm text-[#7a6f65] mt-6">
              ...
              <Link href="/login" className="text-[#3d5c42] font-medium hover:underline">
                Log in
              </Link>
            </p>
          </div>
