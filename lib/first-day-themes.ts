...
export const FIRST_DAY_THEMES: Record<string, FirstDayTheme> = {
  eucalyptus: {
    ...
    fields: [
      ...
      { key: "name",    xPct: 0.185, yPct: 0.792, align: "center", maxWidthPct: 0.15, fontPx: 30 },
      { key: "grade",   xPct: 0.395, yPct: 0.792, align: "center", maxWidthPct: 0.17, fontPx: 27 },
      { key: "year",    xPct: 0.625, yPct: 0.792, align: "center", maxWidthPct: 0.16, fontPx: 27 },
      { key: "age",     xPct: 0.86,  yPct: 0.792, align: "center", maxWidthPct: 0.10, fontPx: 28 },
      // Row 2 — FAVORITE SUBJECT / GOAL THIS YEAR
      { key: "subject", xPct: 0.305, yPct: 0.86,  align: "center", maxWidthPct: 0.26, fontPx: 27 },
      { key: "goal",    xPct: 0.63,  yPct: 0.86,  align: "center", maxWidthPct: 0.34, fontPx: 27 },
    ],
  },
};
